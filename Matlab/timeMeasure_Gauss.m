...
% Set right workspace session file to load trained model
load gauss_exportedTrainedModels_BIS.mat; % Loads Trainned Models
% Loads One Raw Gauss DataWaveform (amp, time) with Gaussian deformation type.
load gauss_gauss1_25dB_testElement.mat; 

% Manual extraction to be use by f_net
esscParams = essc_computingTime(gauss_gauss1_time, gauss_gauss1_amp); 
% -------------------------------------------------------------------------
nTimer = 100;
...
% Function Handle ---------------------------------------------------------
f_essc = @() essc_computingTime(gauss_gauss1_time, gauss_gauss1_amp); 
f_net = @() net_computingTime(Gauss_MLP_30ESSC_trainedModel.predictFcn, esscParams); % handle to function
f = @() cnn_computingTime(Gauss_MLP_30ESSC_trainedModel.predictFcn, gauss_gauss1_time, gauss_gauss1_amp); % handle to function
...
f_essc = @() essc_computingTime(gauss_gauss1_time, gauss_gauss1_amp); 
f_net = @() net_computingTime(Gauss_SVM_30ESSC_trainedModel.predictFcn, esscParams); % handle to function
f = @() cnn_computingTime(Gauss_SVM_30ESSC_trainedModel.predictFcn, gauss_gauss1_time, gauss_gauss1_amp); % handle to function
...
f_essc = @() essc_computingTime(gauss_gauss1_time, gauss_gauss1_amp); 
f_net = @() net_computingTime(Gauss_NB_30ESSC_trainedModel.predictFcn, esscParams); % handle to function
f = @() cnn_computingTime(Gauss_NB_30ESSC_trainedModel.predictFcn, gauss_gauss1_time, gauss_gauss1_amp); % handle to function
...
f_essc = @() essc_computingTime(gauss_gauss1_time, gauss_gauss1_amp); 
f_net = @() net_computingTime(Gauss_KNN_30ESSC_trainedModel.predictFcn, esscParams); % handle to function
f = @() cnn_computingTime(Gauss_KNN_30ESSC_trainedModel.predictFcn, gauss_gauss1_time, gauss_gauss1_amp); % handle to function
...
save('Gauss_timeModelMAt_essc','timeModelMAt_essc');
save('Gauss_timeModelMAt_net','timeModelMAt_net');
save('Gauss_timeModelMAt_endToend','timeModelMAt_endToend');