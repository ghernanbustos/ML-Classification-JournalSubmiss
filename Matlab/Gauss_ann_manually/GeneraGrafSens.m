...
clear all,clc;
%%%% Datos
Dir_calc = 'C:\Users\guill\OneDrive\Escritorio\Master_ann_paper_hpo\0_PAPER_Review_ML_Traditional_ClassificationLearner\Gauss_ann_manually';
...
for nf = 1:5
    valp = [];
    for n=1:10
        valp = [valp; vint(nf,n) vsig(nf,n) vder(nf,n)];
    end
