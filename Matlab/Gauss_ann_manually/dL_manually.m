...
load gauss_exportedTrainedModels_BIS.mat; % Model exporterd from Classification Learner app.
...
[layer4_size,~] = size(Gauss_MLP_30ESSC_trainedModel.ClassificationNeuralNetwork.LayerWeights{4});
...
ml_compact = compact(Gauss_MLP_30ESSC_trainedModel.ClassificationNeuralNetwork)
% 
...
% Plot CM with row and columns labled.
    ...
    trueLabels = categorical(dataSet_gauss_30params_test10db_numberedLabel(:,31), 1:5, classLabel);
